...
final class QuickSort {
    ...
    static void sort(int[] a, int parallelism, int low, int high) {
        ...
        if (parallelism > 1 && size > MIN_PARALLEL_SORT_SIZE) {
            ...
            new QuickSort.Sorter(null, a, b, low, size, low, depth).invoke();
        } else {
     ...
     * @param high the index of the last element, exclusive, to be sorted
     */
    static void sort(QuickSort.Sorter sorter, int[] a, int bits, int low, int high) {
        while (true) {
     ...
     */
    private static boolean tryMergeRuns(QuickSort.Sorter sorter, int[] a, int low, int size) {
    ...
    private static int[] mergeRuns(int[] a, int[] b, int offset,
        ...
        if (parallel && hi - lo > MIN_RUN_COUNT) {
            QuickSort.RunMerger merger = new QuickSort.RunMerger(a, b, offset, 0, run, mi, hi).forkMe();
        ...
        if (parallel) {
            new QuickSort.Merger(null, dst, k, a1, lo1, hi1, a2, lo2, hi2).invoke();
        } else {
     ...
     */
    private static void mergeParts(QuickSort.Merger merger, int[] dst, int k,
...
// [long]
     ...
     * @param high the index of the last element, exclusive, to be sorted
     */
    static void sort(QuickSort.Sorter sorter, long[] a, int bits, int low, int high) {
        while (true) {
            int end = high - 1, size = high - low;
     ...
     * @return true if finally sorted, false otherwise
     */
    private static boolean tryMergeRuns(QuickSort.Sorter sorter, long[] a, int low, int size) {
     ...
     * @param hi2 the end index of the second part, exclusive
     */
    private static void mergeParts(QuickSort.Merger merger, long[] dst, int k,
...
// [float]
     ...
     * @param high the index of the last element, exclusive, to be sorted
     */
    static void sort(QuickSort.Sorter sorter, float[] a, int bits, int low, int high) {
        while (true) {
            int end = high - 1, size = high - low;
     ...
     * @return true if finally sorted, false otherwise
     */
    private static boolean tryMergeRuns(QuickSort.Sorter sorter, float[] a, int low, int size) {
     ...
     * @param hi2 the end index of the second part, exclusive
     */
    private static void mergeParts(QuickSort.Merger merger, float[] dst, int k,
...
// [double]
     ...
     * @param high the index of the last element, exclusive, to be sorted
     */
    static void sort(QuickSort.Sorter sorter, double[] a, int bits, int low, int high) {
        while (true) {
            int end = high - 1, size = high - low;
     ...
     * @return true if finally sorted, false otherwise
     */
    private static boolean tryMergeRuns(QuickSort.Sorter sorter, double[] a, int low, int size) {
     ...
     * @param hi2 the end index of the second part, exclusive
     */
    private static void mergeParts(QuickSort.Merger merger, double[] dst, int k,
...
// [class]
    ...
    private static final class Sorter extends CountedCompleter<Void> {
        ...
        public final void compute() {
            if (depth < 0) {
                setPendingCount(2);
                int half = size >> 1;
                new QuickSort.Sorter(this, b, a, low, half, offset, depth + 1).fork();
                new QuickSort.Sorter(this, b, a, low + half, size - half, offset, depth + 1).compute();
            } else {
                if (a instanceof int[]) {
        ...
        private void forkSorter(int depth, int low, int high) {
            ...
            new QuickSort.Sorter(this, a, b, low, high - low, offset, depth).fork();
        }
    }
    ...
    private static final class Merger extends CountedCompleter<Void> {
        ...
        private void forkMerger(Object dst, int k,
                                Object a1, int lo1, int hi1, Object a2, int lo2, int hi2) {
            addToPendingCount(1);
            new QuickSort.Merger(this, dst, k, a1, lo1, hi1, a2, lo2, hi2).fork();
        }
    }
    ...
    private static final class RunMerger extends RecursiveTask<Object> {
        ...
        private QuickSort.RunMerger forkMe() {
            fork();
            return this;
        }
